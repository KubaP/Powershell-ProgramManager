...
foreach ($command in $commands) {
    ...
    Describe "Test help for $commandName" {
        ...
        $testhelpall += 1        
        # Make sure there is actual help content written
        ...
        $testhelpall += 1
        # Make sure the help description is not empty
        ...
        $testhelpall += 1
        # Make sure the example has an actual description
        ...
        # Check if the general help ran without errors
        ...
        Context "Test parameter help for $commandName" {
            ...
            foreach ($parameter in $parameters) {
                ...
                $testparamsall += 1
                # Make sure every parameter has a description written
                ...
                $testparamsall += 1
                # Make sure help reflects mandatory values
                ...
                # Skip checks if the parameter for this command is excluded
            ...
            foreach ($helpParm in $HelpParameterNames) {
                ...
                $testparamsall += 1
                # Make sure that there aren't any extra parameters in help
