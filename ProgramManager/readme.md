...
If you don't care to deal with the details, this is what you need to do to get started seeing results:
 ...
 - Update the `FunctionsToExport` node in the module manifest (ProgramManager.psd1). All functions you want to publish should be in a list.
 ...
 If you want to make sure your code too will survive OS-specific path notations, get used to using `Resolve-path`.